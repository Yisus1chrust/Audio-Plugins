...
namespace photosynth
{
    ...
    public:
        ...
        // Web bridge helpers
        juce::var createBridgeState() const;
        bool setParameterFromBridge(const juce::String& parameterID, double value);
        void playNoteFromBridge(int note, float velocity);
        void releaseNoteFromBridge(int note);
        void panicFromBridge();
